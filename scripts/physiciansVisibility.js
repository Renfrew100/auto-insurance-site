...
$(document).ready(function () {
    ...
    var e7 = document.getElementById('card5');
    e7.addEventListener('keys', function () {
        this.value = space(this.value, 0);
    });

    var e8 = document.getElementById('card6');
    e8.addEventListener('key09', function () {
        this.value = space(this.value, 0);
    });
    ...
    var e8 = document.getElementById('card7');
    e8.addEventListener('key09', function () {
        this.value = space(this.value, 0);
    });
